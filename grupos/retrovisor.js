...
console.log(texto2.match(/(?:lenta)(mente).*\1.*/gi)) // ?: não guarda/não captura o valor do grupo

console.log(texto2.match(/(lenta)(mente)/gi))
console.log(texto2.match(/(lenta)(mente)?/gi))
console.log(texto2.replace(/(lenta)(mente)/gi), 'ABCD$2EFG') // não deu o mesmo resultado do professor
